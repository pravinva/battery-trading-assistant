...
# MAGIC %md
# MAGIC # Process PDF and Create Vector Search Index
# MAGIC 
# MAGIC This notebook processes battery.pdf and creates a Vector Search index using the shared endpoint.

# COMMAND ----------
# MAGIC %pip install databricks-vectorsearch pypdf langchain-text-splitters pandas
...
# COMMAND ----------
# MAGIC %md
# MAGIC ## Save Chunks to Delta Table
...
try:
    ...
    if "already exists" in str(e).lower() or "RESOURCE_ALREADY_EXISTS" in str(e):
        print(f"⚠️  Index already exists. Syncing existing index...")
