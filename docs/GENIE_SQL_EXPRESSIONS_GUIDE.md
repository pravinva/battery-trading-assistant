...
### Measure 6: Total Energy Throughput
- **Name**: `Total Energy Throughput`
- **SQL Expression**: `SUM(battery_telemetry.throughput_mwh)`
- **Synonyms** (optional): `total throughput, energy throughput, total throughput MWh`
- **Instructions** (optional): `Total energy throughput in MWh from telemetry table. Use this field directly - do NOT calculate from cumulative energy fields.`

### Measure 7: Number of Intervals
